...
import {Reloj} from './ep05/Reloj';
import tl5 from './data/ep05/timeline.json';
import {CuatroMillones, S4M_TOTAL} from './s4m/CuatroMillones';
...
export const RemotionRoot: React.FC = () => (
  ...
  />
    ...
    <Composition id="CuatroMillones" component={CuatroMillones} durationInFrames={Math.ceil(S4M_TOTAL * 30)} fps={30} width={1080} height={1920} />
