import words from '../data/ep05/words.json';
import timeline from '../data/ep05/timeline.json';
...
/** tiempo absoluto (s) → relativo al segmento */
export const segStart = (seg: string) => TL.starts[seg];
