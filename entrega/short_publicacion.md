# Short promocional: "13 CEROS"

**Archivo:** `13_ceros_short_vertical.mp4` (52 s, 1080×1920, subtítulos incrustados)

## Cómo subirlo
1. Subilo **después** del documental, cuando el video largo ya esté público.
2. **Título:**
   ```
   ¿Por qué los argentinos esconden dólares? 🇦🇷
   ```
3. **Descripción:**
   ```
   US$ 220.000 millones fuera del sistema. La respuesta tiene 13 ceros.
   ▶ Documental completo en el canal.
   #Argentina #Dólar #Shorts
   ```
